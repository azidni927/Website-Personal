...
const prods = {
  getuk1: {
    cat: 'Getuk Goreng', name: 'Getuk Goreng Haji Tohirin 1 KG', sub: 'Resep Asli Sokaraja', price: 'Rp 36.000',
    ...
    img: 'getuk1kg_1.jpeg', badge: 'Terlaris', wa: 'Getuk+Goreng+1+KG'
  },
  getuk2: {
    cat: 'Getuk Goreng', name: 'Getuk Goreng Haji Tohirin 1/2 KG', sub: 'Resep Asli Sokaraja', price: 'Rp 18.000',
    ...
    img: 'getuk1kg_2.jpeg', wa: 'Getuk+Goreng+%C2%BD+KG'
  },
  nopia1: {
    cat: 'Nopia', name: 'Nopia Gula Jawa', sub: 'Isian Gula Merah', price: 'Rp 26.000',
    desc: 'Nopia khas Banyumas berbentuk bulat dengan kulit tipis renyah dan isian gula aren manis yang harum.',
    specs: [['Varian', 'Gula Jawa / Gula Aren'], ['Bentuk', 'Bulat, ukuran sedang'], ['Masa simpan', '7–14 hari'], ['Kemasan', 'Plastik kedap udara']],
    img: 'nopia_gulajawa.jpeg', wa: 'Nopia+Gula+Jawa'
  },
  nopia2: {
    cat: 'Nopia', name: 'Nopia Rasa Coklat', sub: 'Isian Coklat Lumer', price: 'Rp 26.000',
    desc: 'Nopia dengan isian coklat lembut yang berpadu sempurna dengan kulit renyah.',
    specs: [['Varian', 'Coklat'], ['Bentuk', 'Bulat, ukuran sedang'], ['Masa simpan', '7–14 hari'], ['Kemasan', 'Plastik kedap udara']],
    img: 'nopia_coklat1.jpeg', wa: 'Nopia+Coklat'
  },
  nopia3: {
    cat: 'Nopia', name: 'Nopia Rasa Durian', sub: 'Durian Asli', price: 'Rp 26.000',
    desc: 'Nopia dengan isian durian asli yang harum dan berkarakter. Tersedia musiman.',
    specs: [['Varian', 'Durian'], ['Bentuk', 'Bulat, ukuran sedang'], ['Masa simpan', '7–10 hari'], ['Kemasan', 'Plastik kedap udara']],
    img: 'nopia_durian1.jpeg', wa: 'Nopia+Durian'
  },
  kb1: {
    cat: 'Klanting Bumbu', name: 'Klanting Bumbu Jagung Bakar', sub: 'Pecinta Jagung', price: 'Rp 22.000',
    desc: 'Klanting singkong dengan bumbu jagung bakar yang smoky-manis.',
    specs: [['Varian', 'Jagung Bakar'], ['Tekstur', 'Renyah'], ['Masa simpan', '14–21 hari'], ['Kemasan', 'Plastik standing pouch']],
    img: 'klanting_bumbu_jagungbakar.jpeg', wa: 'Klanting+Jagung+Bakar'
  },
  kb2: {
    cat: 'Klanting Bumbu', name: 'Klanting Bumbu Pedas Manis', sub: 'Pedas Pas', price: 'Rp 22.000',
    desc: 'Perpaduan pedas dan manis yang seimbang. Tingkat kepedasan sedang.',
    specs: [['Varian', 'Pedas Manis'], ['Tingkat pedas', 'Sedang'], ['Masa simpan', '14–21 hari'], ['Kemasan', 'Plastik standing pouch']],
    img: 'klanting_bumbu_pedasmanis.jpeg', wa: 'Klanting+Pedas+Manis'
  },
  kb3: {
    cat: 'Klanting Bumbu', name: 'Klanting Bumbu Bawang', sub: 'Gurih Bawang', price: 'Rp 22.000',
    desc: 'Aroma bawang goreng yang kuat dengan rasa gurih-asin sempurna.',
    specs: [['Varian', 'Bawang'], ['Rasa', 'Gurih Bawang'], ['Masa simpan', '14–21 hari'], ['Kemasan', 'Plastik standing pouch']],
    img: 'klanting_bumbu_bawang.jpeg', wa: 'Klanting+Bawang'
  },
  kb4: {
    cat: 'Klanting Bumbu', name: 'Klanting Bumbu Keju', sub: 'Keju Gurih', price: 'Rp 22.000',
    desc: 'Taburan bumbu keju creamy dan gurih di atas klanting renyah.',
    specs: [['Varian', 'Keju'], ['Rasa', 'Gurih Keju'], ['Masa simpan', '14–21 hari'], ['Kemasan', 'Plastik standing pouch']],
    img: 'klanting_bumbu_keju.jpeg', wa: 'Klanting+Keju'
  },
  ko1: {
    cat: 'Klanting Original', name: 'Klanting Original Besar', sub: 'Kepingan Besar', price: 'Rp 20.000',
    desc: 'Klanting tanpa bumbu tambahan ukuran besar. Cita rasa singkong asli yang natural.',
    specs: [['Varian', 'Original / Polos'], ['Ukuran', 'Besar'], ['Masa simpan', '30+ hari'], ['Kemasan', 'Plastik kedap']],
    img: 'klanting_originalbesar.jpeg', wa: 'Klanting+Original+Besar'
  },
  ko2: {
    cat: 'Klanting Original', name: 'Klanting Original Kecil', sub: 'Kepingan Kecil', price: 'Rp 20.000',
    desc: 'Klanting original ukuran kecil yang praktis untuk isian toples atau souvenir.',
    specs: [['Varian', 'Original / Polos'], ['Ukuran', 'Kecil'], ['Masa simpan', '30+ hari'], ['Kemasan', 'Plastik kedap']],
    img: 'klanting_originalkecil.jpeg', wa: 'Klanting+Original+Kecil'
  },
  ko3: {
    cat: 'Klanting Original', name: 'Klanting Original Warna', sub: 'Warna Warni', price: 'Rp 20.000',
    desc: 'Klanting original dengan warna-warni alami dari pewarna food grade. Cocok untuk souvenir.',
    specs: [['Varian', 'Aneka Warna'], ['Pewarna', 'Alami / Food Grade'], ['Masa simpan', '30+ hari'], ['Kemasan', 'Plastik kedap']],
    img: 'klanting_originalwarna.jpeg', wa: 'Klanting+Original+Warna'
  }
};
...
/* ---- Highlight helper (dipakai saat search aktif) ---- */
...
/* ---- Filter katalog (by tab kategori) ---- */
function filterCatalog(btn, cat) {
  document.querySelectorAll('.ftab').forEach(t => t.classList.remove('active'));
  if (btn) btn.classList.add('active');

  // Kalau ada search query aktif, filter juga berdasarkan query
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const grid = document.getElementById('grid');
  if (!grid) return; // bukan halaman produk.html, stop di sini
  ...
  // Render semua kartu (dengan highlight jika ada query)
  renderCatalogProducts(queryParam);

  // Isi input search kalau ada query dari URL
  ...
  // Kalau ada ?modal=id di URL, buka modal langsung
  if (modalParam && prods[modalParam]) {
    openModal(modalParam);
    // Bersihkan URL supaya refresh tidak re-buka modal
    const url = new URL(window.location);
